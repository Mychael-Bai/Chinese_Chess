...
class ChineseChess:
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Chinese Chess 3.7.6")
        ...
        # Create undo button with the same style as restart button
        ...
        # Move restart button to button frame and pack it to the right of undo
    ...
    def undo_move(self):
        if self.move_history:
            ...
            from_pos, to_pos, captured_piece = last_move
            ...
            if self.selected_piece:
                ...
                if (clicked_piece and 
                    ...
                    if self.is_in_check(self.current_player):
                        ...
                        messagebox.showwarning("Invalid Move", "This move would put your king in check!")
                    else:
                        ...
                        if self.is_in_check(self.current_player):
                            messagebox.showinfo("Check!", f"{self.current_player.capitalize()} king is in check!")
