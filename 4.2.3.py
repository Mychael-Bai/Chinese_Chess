...
class ChineseChess:
    ...
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Chinese Chess 4.1(good)")
    ...
    def show_centered_warning(self, title, message):
        ...
        # Get the board window's position and dimensions
        board_x = self.window.winfo_x() + self.board_frame.winfo_x() + self.canvas.winfo_x()
        board_y = self.window.winfo_y() + self.board_frame.winfo_y() + self.canvas.winfo_y()
        ...
        # Remove window decorations to make it look like a messagebox
        warn_window.transient(self.window)
        warn_window.grab_set()
        
        # Calculate center position
        x = board_x + (board_width - warn_window.winfo_width()) // 2
        y = board_y + (board_height - warn_window.winfo_height()) // 2
        ...
        # Position the window and wait for it to appear
        warn_window.update_idletasks()
        
        # Now center it on the board
