...
class ChineseChess:
    ...
    def minimax(self, depth, alpha, beta, maximizing_player, is_pv_node=True):
        ...
        if maximizing_player:
            ...
            return max_eval
        # Similar changes for minimizing player...
    ...
    def make_ai_move(self):
        ...
        max_time = 5.0  # Reduced from 180.0 to 5 seconds per move
        ...
        for current_depth in range(1, 4):  # Reduced max depth from 6 to 4
