...
class ChineseChess:
    ...
    def __init__(self):
        ...
        self.cell_size = 54
        self.piece_radius = 22  # Smaller pieces to fit on intersections
    ...
    def end_replay(self):
        ...
        self.next_move_button.config(state=tk.DISABLED)
        self.prev_move_button.config(state=tk.DISABLED)  # Add this line
        self.initialize_board()
        self.draw_board()
                ...
                if piece:
                    ...
                    if piece[0] == 'B':  # Black pieces (AI)
                        ...
                        if piece[1] == '卒':  # Pawn
                            ...
                            # Bigger bonus after crossing river
                            if row > 4:
                                score += 50 + (row - 4) * 20  # Progressive bonus after crossing
                            else:
                                score += row * 10  # Small bonus for advancement before crossing
    ...
    def make_ai_move(self):
        """Make the best move for black pieces using minimax with time limit"""
        import time
        
        start_time = time.time()
        max_time = 10.0  # Maximum time in seconds for making a move
        ...
        # Start with depth 2 and increase if time allows
        for search_depth in range(2, 4):
